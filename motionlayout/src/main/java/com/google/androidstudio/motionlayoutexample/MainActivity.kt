...
class MainActivity : AppCompatActivity(), CompoundButton.OnCheckedChangeListener {
    ...
    private val dataset: Array<DemosAdapter.Demo> = arrayOf(
            DemosAdapter.Demo("Basic Example (1/4)", "Basic motion example using referenced ConstraintLayout files", R.layout.motion_01_basic),
            DemosAdapter.Demo("Basic Example (2/4)", "Basic motion example using ConstraintSets defined in the MotionScene file", R.layout.motion_02_basic),
            DemosAdapter.Demo("Basic Example (3/4)", "Basic motion example same as 2, but autoComplete is set to false in onSwipe", R.layout.motion_02_basic_autocomplete_false),
            DemosAdapter.Demo("Basic Example (4/4)", "Basic motion example ", R.layout.motion_29_basic),
            DemosAdapter.Demo("Basic listener", "Basic motion listener ", ListenerActivity::class.java),
            ...
            DemosAdapter.Demo("Keyframe Position (1/4)", "Use a simple keyframe to change the interpolated motion", R.layout.motion_06_keyframe),
            DemosAdapter.Demo("Keyframe Position (2/4)", "Use a simple keyframe to change the interpolated motion", R.layout.motion_31_keyframe),
            DemosAdapter.Demo("Keyframe Interpolation (3/4)", "More complex keyframe, adding rotation interpolation", R.layout.motion_07_keyframe),
            DemosAdapter.Demo("Keyframe Cycle (4/4)", "Basic example of using a keyframe cycle ", R.layout.motion_08_cycle),
            DemosAdapter.Demo("Keyframe KeyAttributes(1/2)", "KeyAttributes", R.layout.motion_27_keyframe),
            DemosAdapter.Demo("Keyframe KeyAttributes(2/2)", "KeyAttributes", R.layout.motion_28_keyframe),
